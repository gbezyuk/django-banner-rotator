...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Banner.file'
        db.alter_column('banner_rotator_banner', 'file', self.gf('filebrowser.fields.FileBrowseField')(max_length=1000))

        # Changing field 'Click.user_agent'
        db.alter_column('banner_rotator_click', 'user_agent', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Banner.file'
        db.alter_column('banner_rotator_banner', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Click.user_agent'
        db.alter_column('banner_rotator_click', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'banner_rotator.banner': {
            ...
            'file': ('filebrowser.fields.FileBrowseField', [], {'max_length': '1000'}),
