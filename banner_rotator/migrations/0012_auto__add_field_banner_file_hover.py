...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.file_hover'
        db.add_column('banner_rotator_banner', 'file_hover',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Banner.file_hover'
        db.delete_column('banner_rotator_banner', 'file_hover')
    ...
    models = {
        ...
        'banner_rotator.banner': {
            ...
            'file_hover': ('filebrowser.fields.FileBrowseField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
